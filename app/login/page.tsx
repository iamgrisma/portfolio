...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-dark-900 flex items-center justify-center p-6 relative overflow-hidden">
      {/* Background effects */}
      <div className="blob-green top-0 -left-32 opacity-30" />
      <div className="blob-teal bottom-0 right-0 opacity-20" />
      <div className="blob-purple top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-10" />
      ...
      <Link
        href="/"
        className="absolute top-8 left-8 flex items-center gap-2 text-sm text-dark-200 hover:text-accent-400 transition-colors group z-10"
      >
        ...
        <div className="glass-card rounded-2xl p-8 sm:p-10">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-dark-800 px-4 text-xs text-dark-400">or continue with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label htmlFor="login-email" className="block text-sm font-medium text-dark-100 mb-2">Email</label>
            ...
            <div>
              <label htmlFor="login-password" className="block text-sm font-medium text-dark-100 mb-2">Password</label>
              <div className="relative">
